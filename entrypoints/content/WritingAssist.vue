<template>
    ...
    >
        ...
        >
            ...
            <div class="flex flex-col gap-2" v-if="suggestions.length > 0">
                <Suggestion
        ...
        <div class="flex items-center gap-2 h-8">
            <Transition name="toast">
                <div
                    v-if="showToast"
                    class="bg-white rounded shadow p-x2 text-sm text-gray-700 h-full flex items-center"
                >
                    复制成功
                </div>
            </Transition>
            <div
                class="cursor-pointer h-full w-8 border-gray-600 border border-solid"
